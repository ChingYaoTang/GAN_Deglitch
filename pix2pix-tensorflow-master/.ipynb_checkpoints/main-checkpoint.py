...
parser.add_argument('--dataset_name', dest='dataset_name', default='GW', help='name of the dataset')
parser.add_argument('--epoch', dest='epoch', type=int, default=10, help='# of epoch')
parser.add_argument('--batch_size', dest='batch_size', type=int, default=1, help='# images in batch')
parser.add_argument('--train_size', dest='train_size', type=int, default=9000, help='# images used to train')
...
parser.add_argument('--ngf', dest='ngf', type=int, default=8, help='# of gen filters in first conv layer')
...
parser.add_argument('--lr', dest='lr', type=float, default=0.002, help='initial learning rate for adam')
...
parser.add_argument('--checkpoint_dir', dest='checkpoint_dir', default='/work1/tom982239/checkpoint', help='models are saved here')
parser.add_argument('--sample_dir', dest='sample_dir', default='/work1/tom982239/sample', help='sample are saved here')
parser.add_argument('--test_dir', dest='test_dir', default='/work1/tom982239/test', help='test sample are saved here')
parser.add_argument('--logs_dir', dest='logs_dir', default='/work1/tom982239/logs', help='logs are saved here')
